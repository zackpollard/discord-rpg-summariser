...
func (s *Server) setupRoutes() {
	...
	s.mux.HandleFunc("GET /api/campaigns/{id}/relationship-graph", s.handleRelationshipGraph)
	...
	s.mux.HandleFunc("GET /api/sessions/{id}/combat", s.handleGetSessionCombat)
